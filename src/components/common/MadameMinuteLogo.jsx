...
export function MadameMinuteLogo({ size = 42, className = '' }) {
  ...
  return (
    <div 
      ...
      title="Madame Minute - TMA Chrono Assistant"
    >
      {/* Outer TMA Clock Gear Aura */}
...
export const MissMinutesLogo = MadameMinuteLogo
