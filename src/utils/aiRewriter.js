 ...
 * Turns simple notes like "fixed bug" or "meeting with client" into executive TVA-grade work logs.
 */
...
const REWRITE_RULES = [
  ...
  { keywords: ['design', 'ui', 'ux', 'figma', 'mockup', 'wireframe'], action: 'Architected high-fidelity UI component interface', detail: 'crafted responsive layout tokens, implemented design system standards, and ensured TVA accessibility compliance.' },
...
export function rewriteTaskDescription(rawInput, project = 'TVA Vault') {
